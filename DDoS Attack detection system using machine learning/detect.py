...
for i in range(0,length):
	...
	if(b>start and b<=end):
		...
		if((sourceip=='10.3.3.63')):#change to ur current lan ip address
...
print("")
print("------------------------------------------------------------------------------")
print(" Detection using Decision Tree with accuracy of 99.24% and precision of 0.94  ")
print("------------------------------------------------------------------------------")
print(prediction)
#print(prediction2)
#print(prediction3)
...
if len(set(attackerip))!=0:
	...
	server.starttls()
	server.ehlo()
	server.login("paulpogbatrial@gmail.com","kletech@123") #change to your login credientials to get the attacking address to your mail id.........
	text = msg.as_string()
